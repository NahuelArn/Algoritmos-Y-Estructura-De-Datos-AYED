...
public class main {
	public static void main(String[] args) {
		...
		ProfundidadDeArbolBinario clase = new ProfundidadDeArbolBinario(a);
		
		System.out.println("La suma es: "+ clase.sumaElementosProfundidad(3));
